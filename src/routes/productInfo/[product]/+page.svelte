<script>
  ...
  var info = data.ProductItem ;

  var product = $page.params.product ;

  console.log(product) ;

  var myProduct = info.filter(function (item) {return item.UrlName == product});
    ...
    <div class="row gy-4 gy-md-0">
        ...
        <div class="col-md-6 d-md-flex align-items-md-center">
            <div style="max-width: 350px;">
                ...
                <p class="my-3">Tincidunt laoreet leo, adipiscing taciti tempor. Primis senectus sapien, risus donec ad fusce augue <span class="ziss">₹ {productInfo.Price}</span></p><a class="btn btn-primary btn-lg me-2" role="button" href="" on:click={ria}>Buy Now</a><a class="btn btn-primary btn-lg me-2" role="button" href="" on:click={dia}>Zapier</a>
            </div>
        </div>
    </div>
</div>
